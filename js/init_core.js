...
window.radian_to_degrees=radian_to_degrees;
window.degrees_to_radian=degrees_to_radian;
...
window.vector3_2=vector3_2;
window.quaternion=quaternion;


window.sounds_play=sounds_play;
...
debug_set("Sprite solid","sprite_solid");
...
tex["atlas_sprite"]=DataArrayTexture_set([tex["atlas-0"],tex["atlas-1"]]);
...
action["soldier_attack_1"]=THREE.AnimationUtils.subclip(mesh["walk"].animations[0],"attack",0,100);
...
mesh["soldier_attack_1"].scale.set(0.05,0.05,0.05);
...
action["soldier_attack_2"]=THREE.AnimationUtils.subclip(mesh["soldier"].animations[0],"attack",0,100);
...
mesh["soldier_1_gun"].position.set(3,12,3);
mesh["soldier_1_gun"].scale.set(2000,2000,2000);
mesh["soldier_1_gun"].rotation.set(0,3.14,1.57);
...
mesh["soldier_2_gun"].position.set(3,12,3);
mesh["soldier_2_gun"].scale.set(2000,2000,2000);
mesh["soldier_2_gun"].rotation.set(0,3.14,1.57);
